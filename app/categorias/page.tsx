  ...
  return (
    <main className="min-h-screen bg-black text-white p-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        {/* ANIME */}
        <div className="bg-zinc-900 p-8 rounded-2xl border border-purple-500/20 hover:border-purple-500 hover:-translate-y-2 hover:shadow-[0_0_30px_rgba(168,85,247,0.35)] transition duration-300 cursor-pointer">
